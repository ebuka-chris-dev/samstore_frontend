...
const LoginCover = () => {
  ...
  const login = async () => {
    ...
    try {
      const rs = await request('login', 'POST', false, data);
      if (rs.status === 'ok') {
      ...
      <Row className='auth-inner m-0'>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <CardText className='mb-2 text-danger'>{msg}</CardText>
            ...
            <Form className='auth-login-form mt-2' onSubmit={e => e.preventDefault()}>
              <div className='mb-1'>
                ...
                <Input type='text' id='login-email' onChange={e => setUsername(e.target.value)} placeholder='enter username' autoFocus />
              </div>
              <div className='mb-1'>
